...
/**
 * LOGIN PAGE
 * Matches GoFlipo/Support design exactly:
 * - Left: hero text + branding
 * - Right: login card with Operator ID + Passcode
 * - Background: light warm gradient (off-white → soft lavender bottom-left, teal top-right)
 * - CTA: teal "ENTER CONSOLE →" button
 * - Footer hints: SSO · SAML | SESSION · 8H
 */
...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('ops@goflipo.in')   // pre-filled like design
  ...
  return (
    /*
     * Full-page layout:
     * - background replicates the subtle off-white with lavender hint bottom-left
     *   and very soft teal hint top-right (matching screenshot)
     * - Two column: left hero text, right card
     */
      ...
      <main className="main-content">
        ...
        <section className="card-wrap">
          <div className="login-card">
            ...
            {/* Footer hints — matching design exactly */}
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .login-root {
          ...
          /* Replicates the screenshot background:
             off-white base, subtle lavender bottom-left, soft teal top-right */
          background:
        ...
        .hero-eyebrow {
          ...
          color: #5b9e98;  /* muted teal — matches screenshot */
          margin-bottom: 20px;
        }
        .hero-headline {
        ...
        .card-eyebrow {
          ...
          color: #1a9e8c;   /* teal accent — exact match */
          margin-bottom: 8px;
        }
        .card-title {
        ...
        .field-input:focus {
          border-color: #1a9e8c;
          box-shadow: 0 0 0 3px rgba(26,158,140,0.12);
          background: #fff;
        }
        ...
        .submit-btn {
          margin-top: 4px;
          height: 44px;
          background: #1a9e8c;   /* teal — exact color from design */
          color: #fff;
          border: none;
          border-radius: 8px;
